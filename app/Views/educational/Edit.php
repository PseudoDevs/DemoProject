                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <form action="/admin/educational/update" method="post">
                                            ...
                                            <div class="col-12">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text"  value="<?=$guarantee['schoolname']?>"  name="schoolname" class="form-control" required data-validation-required-message="This field is required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <select name="school" id="school" required class="form-control">
                                                            <option value="<?=$guarantee['school']?>" selected hidden><?=$guarantee['school']?></option>
